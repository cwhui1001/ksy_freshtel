...
export default function AboutUsPage() {
  return (
    <main className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-[#FFF4F4] pt-32 pb-20 md:pt-48 md:pb-32 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
            <h1 className="text-4xl md:text-6xl font-black text-[#1B365D] uppercase tracking-tight mb-6">
                About Us
            </h1>
            <p className="text-lg md:text-xl text-zinc-600 max-w-3xl mx-auto font-medium leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 mb-20 text-center md:text-left">
            <div className="inline-block px-4 py-1.5 bg-[#EF4444]/10 rounded-full">
                <span className="text-[#EF4444] text-xs font-black uppercase tracking-widest">Our Mission</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start mb-20">
            <div className="space-y-6">
              <h2 className="text-3xl font-black text-[#1B365D] uppercase">Who We Are</h2>
              ...
              <div className="bg-[#F9F8F3] p-8 rounded-3xl border border-zinc-100 shadow-sm mt-8">
                <h3 className="text-sm font-black text-zinc-400 uppercase tracking-widest mb-4 italic">Assisting you with:</h3>
                <ul className="space-y-3">
                    {[
                        ...
                        <li key={i} className="flex items-center gap-3 text-zinc-800 font-bold text-sm">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-black text-[#1B365D] uppercase">What We Provide</h2>
              <div className="space-y-4">
                <h3 className="text-lg font-black text-[#EF4444] uppercase">Residential Fibre Broadband</h3>
                <p className="text-zinc-600 font-medium italic">Reliable high-speed internet for:</p>
                <div className="flex flex-wrap gap-2">
                    {["Streaming", "Gaming", "Work from home", "Smart home devices", "Online learning"].map(tag => (
                        <span key={tag} className="px-4 py-2 bg-white border-2 border-zinc-100 text-zinc-600 rounded-xl text-xs font-black uppercase tracking-tightest">
                            {tag}
                        </span>
                    ))}
                </div>
              ...
              <div className="space-y-4 pt-4 border-t border-zinc-100">
                <p className="text-zinc-600 font-medium">We help customers with:</p>
                <ul className="grid grid-cols-1 gap-2">
                    {["Fibre package consultation", "Coverage checking", "Registration assistance", "Installation appointment coordination"].map(item => (
                        <li key={item} className="flex items-center gap-3 text-zinc-800 font-bold text-xs uppercase tracking-tightest">
          ...
          {/* Why Choose Us */}
          <div className="bg-[#1B365D] rounded-[3rem] p-12 md:p-16 text-white mb-20 relative overflow-hidden">
            ...
            <h2 className="text-3xl font-black uppercase mb-12 relative z-10">Why Customers Choose Us</h2>
