  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-[#F9F8F3] rounded-3xl p-8 sm:p-12 shadow-sm border border-zinc-200">
          {step === 1 && (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="space-y-6">
        <div>
          ...
          <input 
            list="locations"
            className="w-full bg-white border-2 border-zinc-300 rounded-xl px-6 py-4 focus:border-[#EF4444] outline-none transition-all font-bold text-zinc-900 placeholder:text-zinc-300"
        ...
        <div>
          ...
          <select 
            className="w-full bg-white border-2 border-zinc-300 rounded-xl px-6 py-4 focus:border-[#EF4444] outline-none transition-all font-bold appearance-none text-zinc-900"
            value={formData.plan}
                  ...
                  <button
                    ...
                    className={`flex-1 min-w-[120px] p-4 rounded-xl border-2 transition-all text-center ${
                      formData.contract === c.value 
                        ...
                        : 'border-zinc-300 bg-white text-zinc-400 hover:border-zinc-300'
                    }`}
                  >
                    <div className="text-lg font-black">{c.label || c.value}</div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <input 
            className="w-full bg-white border-2 border-zinc-300 rounded-xl px-6 py-4 mb-4 focus:border-[#EF4444] outline-none transition-all font-bold text-zinc-900 placeholder:text-zinc-300" 
            placeholder="Unit No."
          ...
          />
          <input 
            className="w-full bg-white border-2 border-zinc-300 rounded-xl px-6 py-4 font-bold text-zinc-900 placeholder:text-zinc-300 focus:border-[#EF4444] outline-none transition-all" 
            placeholder="Country" 
        ...
        <div>
          <label className="block text-sm font-black text-zinc-900 uppercase tracking-widest mb-2">I&apos;m a tenant</label>
          <div className="flex gap-4">
            <button 
              className={`flex-1 py-4 rounded-xl font-black text-sm tracking-widest transition-all ${
                formData.isTenant === true ? 'bg-[#EF4444] text-white shadow-lg' : 'bg-white border-2 border-zinc-300 text-zinc-400'
              }`}
            ...
            <button 
              className={`flex-1 py-4 rounded-xl font-black text-sm tracking-widest transition-all ${
                formData.isTenant === false ? 'bg-[#EF4444] text-white shadow-lg' : 'bg-white border-2 border-zinc-300 text-zinc-400'
              }`}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <input 
              type="date" 
              className="w-full bg-white border-2 border-zinc-300 rounded-xl px-4 py-4 focus:border-[#EF4444] outline-none transition-all font-bold text-zinc-900"
    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="flex gap-4">
            <button 
              className={`flex-1 py-4 rounded-xl font-black text-xs tracking-widest transition-all ${
                formData.nationality === 'MALAYSIAN' ? 'bg-[#EF4444] text-white shadow-lg' : 'bg-white border-2 border-zinc-300 text-zinc-400 hover:border-zinc-300'
              }`}
            ...
            <button 
              className={`flex-1 py-4 rounded-xl font-black text-xs tracking-widest transition-all ${
                formData.nationality === 'NON-MALAYSIAN' ? 'bg-[#EF4444] text-white shadow-lg' : 'bg-white border-2 border-zinc-300 text-zinc-400 hover:border-zinc-300'
              }`}
        ...
        <div className="space-y-2">
          ...
          <input 
            type="date"
            className="w-full bg-white border-2 border-zinc-300 rounded-xl px-6 py-4 focus:border-[#EF4444] outline-none transition-all font-bold text-zinc-900"
            value={formData.dob}
      ...
      {/* Attachments */}
      <div className="pt-8 border-t-2 border-zinc-200 space-y-8">
      ...
      <div className="pt-12 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button 
            onClick={onPrev}
            className="flex-1 py-5 rounded-2xl font-black text-sm tracking-[0.2em] transition-all bg-white border-2 border-zinc-300 text-zinc-400 hover:border-zinc-900 hover:text-zinc-900"
          >
            PREV
          </button>
          <button 
...
function Step3Addons({ formData, setFormData, onNext, onPrev }: StepProps) {
  ...
  return (
    <div className="text-center py-10">
      ...
      <div className="space-y-12">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h4 className="text-sm font-black text-zinc-400 uppercase tracking-widest">Voice Plans</h4>
            <div className="h-[2px] flex-1 bg-zinc-100"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {voicePlans.map(plan => (
              <div key={plan.id} className={`bg-white p-8 rounded-2xl border-2 transition-all shadow-sm relative overflow-hidden group hover:border-[#EF4444] ${formData.addons.voicePlanId === plan.id ? 'border-[#EF4444] ring-4 ring-[#EF4444]/5' : 'border-zinc-200'}`}>
                <div className="text-zinc-400 mb-4">
                  <svg className="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                </div>
                <h4 className="text-lg font-black mb-2 text-zinc-900">{plan.name}</h4>
                <div className="text-2xl font-black text-[#EF4444] mb-4">RM {plan.price.toFixed(2)}</div>
                {plan.desc && <p className="text-xs text-zinc-400 font-bold mb-6 italic">{plan.desc}</p>}
                <button 
                  onClick={() => handleToggleVoice(plan)}
                  className={`w-full py-4 rounded-xl font-black transition-all ${formData.addons.voicePlanId === plan.id ? 'bg-zinc-900 text-white' : 'bg-zinc-200 text-zinc-400 hover:bg-[#EF4444] hover:text-white'}`}
                >
        ...
        {routers.length > 0 && (
          <div className="space-y-6 pt-8">
            <div className="flex items-center gap-4 mb-8">
              <div className="h-[2px] flex-1 bg-zinc-100"></div>
              <h4 className="text-sm font-black text-zinc-400 uppercase tracking-widest">Mesh Router Add-ons</h4>
              <div className="h-[2px] flex-1 bg-zinc-100"></div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {routers.map(router => (
                <div key={router.id} className={`bg-white p-8 rounded-2xl border-2 transition-all shadow-sm relative overflow-hidden group hover:border-[#EF4444] ${formData.addons.routerId === router.id ? 'border-[#EF4444] ring-4 ring-[#EF4444]/5' : 'border-zinc-300'}`}>
                  <div className="text-zinc-400 mb-4">
                    <svg className="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0" /></svg>
                  </div>
                  <h4 className="text-lg font-black mb-2 text-zinc-900">{router.name}</h4>
                  <div className="text-2xl font-black text-[#EF4444] mb-4">RM {router.price.toFixed(2)}</div>
                  {router.desc && <p className="text-xs text-zinc-400 font-bold mb-6 italic">{router.desc}</p>}
                  <button 
                    onClick={() => handleToggleRouter(router)}
                    className={`w-full py-4 rounded-xl font-black transition-all ${formData.addons.routerId === router.id ? 'bg-zinc-900 text-white' : 'bg-zinc-200 text-zinc-400 hover:bg-[#EF4444] hover:text-white'}`}
                  >
      ...
      <div className="flex gap-4 justify-center mt-12 pt-12 border-t border-zinc-100">
        <button onClick={onPrev} className="flex-1 max-w-[200px] border-2 border-zinc-300 py-4 rounded-xl font-black text-zinc-400 hover:bg-white transition-all text-xs tracking-widest uppercase">PREV</button>
        <button onClick={onNext} className="flex-1 max-w-[200px] bg-[#EF4444] text-white py-4 rounded-xl font-black shadow-lg hover:bg-red-600 transition-all text-xs tracking-widest uppercase">SUBMIT</button>
      </div>
    </div>
  );
}
